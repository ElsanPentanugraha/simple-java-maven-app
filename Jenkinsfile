node {
    ...
    stage('Deploy') {
            ...
            sh "/usr/bin/scp -i /var/jenkins_home/implementasi-cicd-elsan.pem /var/jenkins_home/workspace/submission-cicd-pipeline-Elsan Pentanugraha/target/submission-elsan-1.0-SNAPSHOT.jar  ec2-user@18.139.84.168:/home/elsan/submission-elsan-1.0-SNAPSHOT.jar"
